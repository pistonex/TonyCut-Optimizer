...
# Asegurarse de que el script se detenga si hay errores
set -e

echo "🚀 Iniciando configuración de TonyCut..."

# ------------------------------------------------------------------
# PASO 3: INSTALACIÓN DE DEPENDENCIAS Y CONFIGURACIÓN DE TAILWIND
# ------------------------------------------------------------------
